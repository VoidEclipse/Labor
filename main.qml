...
ApplicationWindow {
    ...
    Connections
    {
        ...
        onActivateViewInit: {
            ...
            buttonDrawer.enabled = userInfoCpp.login() !== "" && userInfoCpp.password() !== "" && userInfoCpp.token() !== "";
            console.log(userInfoCpp.id() + " " + userInfoCpp.login() + " " + userInfoCpp.password() + " " + userInfoCpp.token());
        }
    }
    ...
    Drawer {
        ...
        Rectangle{
            ...
            Image {
                ...
                x: 15
                y: 12
                source: "qrc:/images/Avatars/student_avatar.png"
                width: 77
                height: 77
                smooth: true
                antialiasing: true
